...
'
    ...
    If gstrAppRemovalLog = "" Then gstrAppRemovalLog = "St5unst"
    
    If gstrSrcPath = "" Then gstrSrcPath = "C:\AUTHSDK_VB5\Client USA0300AS25 1.00.0004" ' App.Path
    gfNoUserInput = (gfSilent Or gfSMS)
    
    If gfSilent = False Then gNonSilentInstall = True
    ...
    ''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    If gNonSilentInstall Then ShowMainForm

    '
    ' Display the welcome dialog
    '
    If gNonSilentInstall Then ShowWelcomeForm
    ''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    '
    ...
    While FileExists(gstrDestDir) = True Or gstrDestDir = gstrNULL
        ...
        Else
    ''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    If gNonSilentInstall Then ShowPathDialog gstrDIR_DEST
    ''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
        End If
    Wend
    ...
    Do
        ...
        '
    ''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    If gNonSilentInstall Then ShowBeginForm
    ''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    ...
    ''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    If gNonSilentInstall Then SetMousePtr gintMOUSE_HOURGLASS
    If gNonSilentInstall Then ShowStaticMessageDialog ResolveResString(resDISKSPACE)
    ''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    ...
    ''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    If gNonSilentInstall Then HideStaticMessageDialog
    If gNonSilentInstall Then SetMousePtr gintMOUSE_DEFAULT
    ''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    ...
    '
    ''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    fAdditionalIcons = True ' Updated this to true
    ''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    ...
    ''''''''''''''''''''''''''JPK 3/17/98 '''''''''''''''''''''''''''
    Call AddGroup("Authenticator")
    strGroupName = "Authenticator"
    fMainGroupWasCreated = True
    ''''''''''''''''''''''''''JPK 3/17/98 '''''''''''''''''''''''''''
    ...
    ''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    If gNonSilentInstall Then ShowCopyDialog
    If gNonSilentInstall Then UpdateStatus frmCopy.picStatus, 0, True
    ''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    ...
    ''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    If gNonSilentInstall Then UpdateStatus frmCopy.picStatus, 1, True
    
    If gNonSilentInstall Then HideCopyDialog
    ''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    '
    ...
    ''''''''''''''''''''''''''JPK 1/25/98 '''''''''''''''''''''''''''
    '/ Get Files to add to registry as GUID's
    Call AddRegistryKeysforFiles
    ''''''''''''''''''''''''''JPK 1/25/98 '''''''''''''''''''''''''''
...
Private Sub ShowBeginForm()
    ...
    Else
''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    If gNonSilentInstall Then frmBegin.Show 1
''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    End If
End Sub
...
Private Sub ShowCopyDialog()
    CenterForm frmCopy
''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    If gNonSilentInstall Then frmCopy.Show
    If gNonSilentInstall Then frmCopy.Refresh
    If gNonSilentInstall Then
        If gfNoUserInput = True Then
