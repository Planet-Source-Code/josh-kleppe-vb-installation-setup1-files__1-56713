...
Public Const gstrINI_REG_SAFE_SCRIPTING_KEY$ = "Safe for Scripting"
...
CheckDSAskSpace:
    ...
    If fDontAskOnSpaceErr = False Then
        ...
        Else
''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    If gNonSilentInstall Then frmDskSpace.Show 1
''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
        End If
...
Sub CopySection(ByVal strSection As String)
    ...
    Do While ReadSetupFileLine(strSection, intIdx, sFile) = True
        ...
        ' handled later.
        '
        If gstrSrcPath = "" Then gstrSrcPath = App.Path & "\"
    ...
    ''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    If gNonSilentInstall Then ExitSetup frmCopy, gintRET_FATAL
    ''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
        End If
        ...
        If sFile.strDestDir <> gstrNULL Then
            ...
            If intRC <> IDIGNORE Then
                ...
                Else
                    ...
                    '**** JPK  ************************************************************
                    If gNonSilentInstall Then CheckOverwritePrivateFile strDestDir & strDestName
                    '**** JPK  ************************************************************
                End If
            End If
...
''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    If gNonSilentInstall Then frmSetup1.SetFocus
''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
...
''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    If gNonSilentInstall Then Unload frmSetup1
''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
...
''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    If gNonSilentInstall Then If fErr Then GoTo BadCommandLine
''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    Else
        fSMS = False
    End If
...
''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    ...
    If strCommand <> "" Then
''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    If gNonSilentInstall Then GoTo BadCommandLine
''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    End If
...
''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    If gNonSilentInstall Then ExitSetup frmSetup1, gintRET_FATAL
''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
...
Sub ShowPathDialog(ByVal strPathRequest As String)
    ...
    '
''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
    If gNonSilentInstall Then frmPath.Show 1
''''''''''''''''''''''''''JPK 1/12/98 '''''''''''''''''''''''''''
